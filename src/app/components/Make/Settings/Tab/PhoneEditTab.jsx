...
var PhoneEditTab = React.createClass({
        ...
        return (
            <div className="setting-container" style={{height:height}}>
                ...
                <div id="setting-base-style">
                    ...
                    <InputText title="电话号码" parameter="item_val" value={GlobalFunc.htmlDecode(attributes['item_val'])}/>
                ...
                <div id="setting-text-family">
                    ...
                    <InputText title="按钮名称" parameter="item_val_sub" value={GlobalFunc.htmlDecode(attributes['item_val_sub'])}/>
