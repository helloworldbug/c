...
var ButtonEditTab = React.createClass({
        ...
        if (this.props.isTimelineFrame === true) {
            ...
            return (
                <div className="setting-container">
                    ...
                    <InputText title="按钮名称" maxLength="10" parameter="item_val" value={GlobalFunc.htmlDecode(attributes["item_val"])}/>
