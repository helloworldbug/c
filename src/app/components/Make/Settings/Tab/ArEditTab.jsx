/**
 * @component ArEditTab
 * @description AR元素编辑设置
 * @time 2016-06-06 18:25
 * @author Yangjian
 **/
...
var ArEditTab = React.createClass({
        ...
        return (
            <div className="setting-container" style={{height:height}}>
                ...
                <div id="setting-base-style">
                    ...
                    {/*<InputText title="电话号码" parameter="item_val" value={attributes['item_val']}/>*/}
