/**
 * @component EmbeddedElement
 * @description 嵌入网页
 * @time 2015-12-17 14:22
 * @author Nick
 **/
...
var EmbeddedElement = React.createClass({
    ...
    render: function () {
        ...
        return (
            <div className='element' style={style} onMouseDown={this.moveElement}>
                <div style={elementDom} className="elementDom embedded">
                    {attributes['item_val_sub']}
                </div>
...
module.exports = EmbeddedElement;