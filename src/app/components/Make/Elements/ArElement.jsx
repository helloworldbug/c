...
var ArElement = React.createClass({
    ...
    render: function () {
        ...
        return (
            <div className='element' style={style} onMouseDown={this.moveElement}>
                <div style={elementDom} className="elementDom ar">
                    {GlobalFunc.htmlDecode(attributes['item_val'])}
                </div>
