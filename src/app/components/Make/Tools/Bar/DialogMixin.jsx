...
var DialogMixin = {
    ...
    componentDidMount: function () {
        ...
        document.getElementsByClassName('modal-body')[0].addEventListener('scroll', this.loadNewImg);
    },

    componentWillUnmount: function () {
        document.removeEventListener('keydown', this.keyDownHandler);
        document.getElementsByClassName('modal-body')[0].removeEventListener('scroll', this.loadNewImg);
    },
    ...
    getUserImage: function (options) {
        ...
        if (!user_id) {
            ...
            UserUtil.getMaterial(function (data) {
                ...
                "uid"           : user_id,
                "material_type" : _this.props.materialType,
                "material_owner": 1,
                "skip"          : _skip,
                "limit"         : _limit
            })
    ...
    getPublicImage: function () {
        ...
        if (this.props.materialType == 10) {
            ...
            TplUtil.getResModel(function (data) {
                ...
                "category"   : _this.props.materialType,
...
/**
    ...
    getHeader  : function () {
        ...
        //如果素材类型为音乐时，增加在线搜索
        if (this.props.materialType == 10) {
            searchInput = <input onClick={this.showSearchMusic} onBlur={this.hideSearchMusic}
                                 onChange={this.searchMusic} type={"text"}
                                 placeholder="在线搜索" className={"media_music_select"}/>
        }
