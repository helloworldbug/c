...
//                },300);
    ...
    LoadingWave.start = function(type,material){
        ...
        cssArr.push(".loading-wave-container{" +
            "top:50%;left:50%;zoom:0.71;position:absolute" +
            "}");
        cssArr.push(".loading-wave-container{" +
        ...
        cssArr.push(".loading-wave-container {" +
            "    animation-duration: 2s;animation-iteration-count: infinite;animation-delay: 0.3s;" +
            "}");
        cssArr.push(".loading-wave-me-container > div{" +
            "position:absolute;width:100%;height:100%" +
            "}");

        if(!document.getElementById("style-loading-wave-animation-make")) {
            var styleNode = document.createElement("style");
            styleNode.type = "text/css";
            styleNode.id = "style-loading-wave-animation-make";
        ...
        if(!loading){
            ...
            clipContainer.className = "clip-maskmake";
            maskContainer.className = "loading-wave-mask";
            shadow.className = "container-shadow";
            maskContainer.appendChild(shadow);
    ...
    LoadingWave.getDom = function(){
        ...
        dom.className = "loading-wave-size loading-wave-container  driftUpDown animated";
        dom.innerHTML = tpl;
        return dom;
    };
    ...
    window.MakeLoadingWave = LoadingWave;
})();