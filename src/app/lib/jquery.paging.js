 ...
 *
 * modify by cq-gli-gonglong--20170425.
 *
 **/
...
(function($, window, undefined) {
    ...
    var PaginationPlug = function(number, opts) {
    ...
    $["fn"]["paging"] = PaginationPlug;
    
    if (define && typeof define === 'function') {
      module.exports = PaginationPlug; 
    } else {
      window.paging = PaginationPlug;
    }
